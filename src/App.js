    ...
    <div id="mainPage">
      ...
      <div id="loadingText" style={{ display: "none" }}>
        <Typography
          variant="h5"
          gutterBottom
          style={{ margin: "auto", fontFamily: "Noto Serif TC", color: "red" }}
        >
          Loading
        </Typography>
      </div>
      <span
        className="processedImageContainer"
        style={{ display: "none" }}
      ...
      <Typography
        ...
        gutterBottom
        id="status"
        style={{ textAlign: "center", fontFamily: "Noto Serif TC" }}
      ></Typography>
      ...
      <div id="blueContainer" className="container" style={{ display: "none" }}>
        {blueArray}
      </div>
      <div
        id="greenContainer"
      ...
      <div id="redContainer" className="container" style={{ display: "none" }}>
        {redArray}
      </div>
      <div
        id="searchContainer"
